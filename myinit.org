...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    ...
    ;; Increase buffer size for read process to speed up language server
    (setq read-process-output-max (* 1024 1024)) ;; 1mb
    ;; Call GC for every 100mb of garbage to speed up language server
...
#+begin_src emacs-lisp :tangle no
  ...
  (org-reload)
#+end_src
** use package - figure out what's with org-plus-contrib :TODO:
...
** slimhtml - investigate what is it and how to replace               :TODO:
#+BEGIN_SRC emacs-lisp
  ;;(use-package ox-slimhtml
  ;;  :ensure t
  ;;  :after org)
#+END_SRC
** checklist - investigate what is it and how to replace  :TODO:
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package lsp-haskell
    :ensure t
    :straight
    (lsp-haskell :type git :host github :repo "emacs-lsp/lsp-haskell")
